...
note1=cat("I am wondering if it's expected for the max.col function to group all as one group.n\
either way, something came out of this, but if looking at the thematrix results (low accuracy, \n
poor CI, and p-value of 0.5), the data were suggested as statistically insignificant. \n
          Or...was that due to the max.col function not working right?")
